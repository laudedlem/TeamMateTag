  ...
  const layouts = {
    ...
    football: unit === 'defense'
      ? {
          ...
          7: { x: 8, y: 29, zone: 'surface', label: 'CB' },
          8: { x: 92, y: 29, zone: 'surface', label: 'CB' },
          9: { x: 22, y: 58, zone: 'surface', label: 'S' },
          10: { x: 78, y: 58, zone: 'surface', label: 'S' },
          11: { x: 50, y: 72, zone: 'surface', label: 'P' },
        }
      : {
          0: { x: 50, y: 31, zone: 'surface', label: 'QB' },
          1: { x: 50, y: 14, zone: 'surface', label: 'RB' },
          2: { x: 7, y: 38, zone: 'surface', label: 'WR' },
          3: { x: 22, y: 37, zone: 'surface', label: 'SLOT' },
          4: { x: 93, y: 38, zone: 'surface', label: 'WR' },
          5: { x: 78, y: 37, zone: 'surface', label: 'TE' },
