...
function frBoardPlacement(sport, unit, slot, index) {
  ...
  const layouts = {
    ...
    football: unit === 'defense'
      ? {
          0: { x: 30, y: 20, zone: 'surface', label: 'EDGE' },
          1: { x: 43, y: 20, zone: 'surface', label: 'DT' },
          2: { x: 57, y: 20, zone: 'surface', label: 'DT' },
          3: { x: 70, y: 20, zone: 'surface', label: 'EDGE' },
          4: { x: 34, y: 42, zone: 'surface', label: 'OLB' },
          5: { x: 50, y: 43, zone: 'surface', label: 'MIKE' },
          6: { x: 66, y: 42, zone: 'surface', label: 'OLB' },
          7: { x: 9, y: 31, zone: 'surface', label: 'CB' },
          8: { x: 91, y: 31, zone: 'surface', label: 'CB' },
          9: { x: 36, y: 59, zone: 'surface', label: 'S' },
          10: { x: 64, y: 59, zone: 'surface', label: 'S' },
          11: { x: 50, y: 79, zone: 'surface', label: 'P' },
        }
      : {
          0: { x: 50, y: 36, zone: 'surface', label: 'QB' },
          1: { x: 50, y: 14, zone: 'surface', label: 'RB' },
          2: { x: 8, y: 43, zone: 'surface', label: 'WR' },
          3: { x: 23, y: 42, zone: 'surface', label: 'SLOT' },
          4: { x: 92, y: 43, zone: 'surface', label: 'WR' },
          5: { x: 77, y: 42, zone: 'surface', label: 'TE' },
          6: { x: 30, y: 58, zone: 'surface', label: 'OT' },
          7: { x: 40, y: 58, zone: 'surface', label: 'OG' },
          8: { x: 50, y: 56, zone: 'surface', label: 'C' },
          9: { x: 60, y: 58, zone: 'surface', label: 'OG' },
          10: { x: 70, y: 58, zone: 'surface', label: 'OT' },
          11: { x: 50, y: 79, zone: 'surface', label: 'K' },
        },
  };
