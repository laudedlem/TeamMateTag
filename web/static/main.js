...
function frBoardPlacement(sport, unit, slot, index) {
  ...
  const layouts = {
    baseball: {
      ...
      3: { x: 66, y: 44, zone: 'surface' },
      4: { x: 28, y: 62, zone: 'surface' },
      5: { x: 34, y: 44, zone: 'surface' },
      6: { x: 19, y: 29, zone: 'surface' },
      7: { x: 50, y: 23, zone: 'surface' },
      8: { x: 81, y: 29, zone: 'surface' },
      9: { x: 50, y: 87, zone: 'surface' },
      10: { x: 14, y: 77, zone: 'sideline', label: 'RP' },
      11: { x: 14, y: 91, zone: 'sideline', label: 'CP' },
    },
    basketball: {
