...
function frBoardPlacement(sport, unit, slot, index) {
  ...
  const layouts = {
    baseball: {
      0: { x: 82, y: 86, zone: 'sideline', label: 'DH' },
      1: { x: 68, y: 62, zone: 'surface' },
      2: { x: 50, y: 60, zone: 'surface' },
      3: { x: 58, y: 44, zone: 'surface' },
      4: { x: 32, y: 62, zone: 'surface' },
      5: { x: 42, y: 44, zone: 'surface' },
      6: { x: 25, y: 25, zone: 'surface' },
      7: { x: 50, y: 16, zone: 'surface' },
      8: { x: 75, y: 25, zone: 'surface' },
      9: { x: 50, y: 86, zone: 'surface' },
      10: { x: 24, y: 75, zone: 'sideline', label: 'RP' },
      11: { x: 8, y: 91, zone: 'sideline', label: 'CP' },
    },
    basketball: {
      0: { x: 50, y: 38, zone: 'surface', label: 'PG' },
      2: { x: 25, y: 55, zone: 'surface', label: 'SG' },
      4: { x: 75, y: 55, zone: 'surface', label: 'SF' },
      6: { x: 38, y: 75, zone: 'surface', label: 'PF' },
      8: { x: 58, y: 75, zone: 'surface', label: 'C' },
      1: { x: 9, y: 18, zone: 'sideline', label: 'PG' },
      3: { x: 9, y: 29, zone: 'sideline', label: 'SG' },
      5: { x: 9, y: 40, zone: 'sideline', label: 'SF' },
      7: { x: 9, y: 51, zone: 'sideline', label: 'PF' },
      9: { x: 9, y: 62, zone: 'sideline', label: 'C' },
      10: { x: 9, y: 73, zone: 'sideline', label: 'BN' },
      11: { x: 9, y: 84, zone: 'sideline', label: 'BN' },
    },
    hockey: {
      0: { x: 31, y: 67, zone: 'surface', label: 'LW' },
      2: { x: 50, y: 78, zone: 'surface', label: 'C' },
      4: { x: 69, y: 67, zone: 'surface', label: 'RW' },
      6: { x: 38, y: 42, zone: 'surface', label: 'LD' },
      8: { x: 62, y: 42, zone: 'surface', label: 'RD' },
      10: { x: 50, y: 92, zone: 'surface', label: 'G' },
      1: { x: 90, y: 24, zone: 'sideline', label: 'LW' },
      3: { x: 90, y: 36, zone: 'sideline', label: 'C' },
      5: { x: 90, y: 48, zone: 'sideline', label: 'RW' },
      7: { x: 90, y: 60, zone: 'sideline', label: 'D' },
      9: { x: 90, y: 72, zone: 'sideline', label: 'D' },
    },
    football: unit === 'defense'
      ? {
          0: { x: 20, y: 43, zone: 'surface', label: 'EDGE' },
          1: { x: 40, y: 43, zone: 'surface', label: 'DT' },
          2: { x: 60, y: 43, zone: 'surface', label: 'DT' },
          3: { x: 80, y: 43, zone: 'surface', label: 'EDGE' },
          4: { x: 32, y: 60, zone: 'surface', label: 'OLB' },
          5: { x: 50, y: 62, zone: 'surface', label: 'MIKE' },
          6: { x: 68, y: 60, zone: 'surface', label: 'OLB' },
          7: { x: 13, y: 77, zone: 'surface', label: 'CB' },
          8: { x: 87, y: 77, zone: 'surface', label: 'CB' },
          9: { x: 38, y: 84, zone: 'surface', label: 'S' },
          10: { x: 62, y: 84, zone: 'surface', label: 'S' },
          11: { x: 50, y: 94, zone: 'sideline', label: 'P' },
        }
      : {
          0: { x: 50, y: 31, zone: 'surface', label: 'QB' },
          1: { x: 50, y: 18, zone: 'surface', label: 'RB' },
          2: { x: 8, y: 43, zone: 'surface', label: 'WR' },
          3: { x: 24, y: 39, zone: 'surface', label: 'SLOT' },
          4: { x: 92, y: 43, zone: 'surface', label: 'WR' },
          5: { x: 76, y: 39, zone: 'surface', label: 'TE' },
          6: { x: 18, y: 59, zone: 'surface', label: 'OT' },
          7: { x: 34, y: 59, zone: 'surface', label: 'OG' },
          8: { x: 50, y: 59, zone: 'surface', label: 'C' },
          9: { x: 66, y: 59, zone: 'surface', label: 'OG' },
          10: { x: 82, y: 59, zone: 'surface', label: 'OT' },
