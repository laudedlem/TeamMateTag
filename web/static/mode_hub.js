...
const PLAYOFF_OPTIONS = {
  ...
  basketball: [
    ...
    ['journeyman', 'Frequent Flyer: 3 Players Who Played for 5 Teams'],
    ['mvp_circle', 'MVP Circle: 3 MVP Winners'],
    ['all_star_marathon', 'All-Star Marathon: 18 Combined All-Star Selections'],
    ['ring_chaser', 'Ring Chaser: 9 Combined Championships'],
  ...
  football: [
    ...
    ['sack_master', 'Sack Master: 3 Players with 100 Career Sacks'],
    ['ballhawk', 'Ballhawk: 3 Players with 30 Career Interceptions'],
    ['one_team', 'One Club: 3 Players with 10 Seasons for One Franchise'],
    ['journeyman', 'Journeyman: 3 Players Who Played for 5 Teams'],
    ['mvp_circle', 'MVP Circle: 3 MVP Winners'],
    ['pro_bowl_marathon', 'Pro Bowl Marathon: 18 Combined Pro Bowl Selections'],
  ...
  hockey: [
    ...
    ['all_star_marathon', 'All-Star Marathon: 18 Combined All-Star Selections'],
    ['ironhorse', 'Ironhorse: 3 Players with 1,200 Career Games'],
    ['ring_chaser', 'Cup Chasers: 10 Combined Stanley Cup Credits'],
