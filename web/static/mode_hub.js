...
const PLAYOFF_OPTIONS = {
  baseball: [
    ['random', 'Random'], ['sunset_kingdom', 'Sunset Kingdom: 4 Japanese Players'], ['havana_heat', 'Havana Heat: 4 Cuban Players'],
    ['maple_corridor', 'Maple Corridor: 5 Canadian Players'], ['mvp_circle', 'MVP Circle: 3 MVP Winners'], ['young_buck', 'Young Buck: 3 Rookie of the Year Winners'],
    ['gonna_be_golden', 'Gonna Be Golden: 3 Gold Glove Winners'], ['secretariat', 'Secretariat: 1 Triple Crown Winner'], ['hound_dog', 'Hound-dog: 3 One-Franchise Players'],
    ['great_bambinos', 'Great Bambinos: 2 500-Home-Run Players'], ['ring_chaser', 'Ring Chaser: 20 Combined World Series Rings'], ['journeyman', 'Journeyman: 3 Seven-Team Players'],
  ],
  basketball: [
    ...
    ['journeyman', 'Frequent Flyer: 4 Players Who Played for 5 Teams'],
    ['mvp_circle', 'MVP Circle: 3 MVP Winners'],
    ['all_star_marathon', 'All-Star Marathon: 24 Combined All-Star Selections'],
    ['ring_chaser', 'Ring Chaser: 12 Combined Championships'],
  ...
  football: [
    ...
    ['sack_master', 'Sack Master: 4 Players with 100 Career Sacks'],
    ['ballhawk', 'Ballhawk: 4 Players with 30 Career Interceptions'],
    ['one_team', 'One Club: 4 Players with 10 Seasons for One Franchise'],
    ['journeyman', 'Journeyman: 4 Players Who Played for 5 Teams'],
    ['mvp_circle', 'MVP Circle: 3 MVP Winners'],
    ['pro_bowl_marathon', 'Pro Bowl Marathon: 24 Combined Pro Bowl Selections'],
    ['ring_chaser', 'Ring Chaser: 12 Combined Championships'],
  ...
  hockey: [
    ...
    ['journeyman', 'Journeyman: 4 Players Who Played for 5 Teams'],
    ['mvp_circle', 'Hart Club: 3 Hart Trophy Winners'],
    ['all_star_marathon', 'All-Star Marathon: 24 Combined All-Star Selections'],
    ['ironhorse', 'Ironhorse: 4 Players with 1,200 Career Games'],
    ['ring_chaser', 'Cup Chasers: 14 Combined Stanley Cup Credits'],
    ['young_guns', 'Fresh Ice: 3 Calder Trophy Winners'],
  ],
};
...
const POWERUP_REFERENCE = {
  ...
  basketball: [['Heat Check', 'Name a Player with a 2,000+ point season. +5 seconds.'], ['Sixth Man', 'Name a Player with 7,000+ career assists. +5 seconds.'], ['Switch', 'Name a Player from the same franchise who played the same position. +5 seconds.'], ['MVP Badge', 'Name an MVP winner. +5 seconds.'], ['Star Power', 'Name an All-Star. +5 seconds.'], ['Timeout', '+15 seconds.'], ['Full-Court Press', 'Your opponent only has 10 seconds on their next turn.']],
  football: [['Trick Play', 'Name a Player with a 20+ touchdown season (non-passing). +5 seconds.'], ['Iron Man', 'Name a Player with 100 career games played. +5 seconds.'], ['Package Change', 'Name a Player from the same franchise who played the same position. +5 seconds.'], ['MVP Badge', 'Name an MVP winner. +5 seconds.'], ['Bowler', 'Name a Pro Bowler. +5 seconds.'], ['Timeout', '+15 seconds.'], ['Blitz', 'Your opponent only has 10 seconds on their next turn.']],
  hockey: [['Breakaway', 'Name a Player with a 400+ goal career. +5 seconds.'], ['Veteran Presence', 'Name a Player with 800+ career points. +5 seconds.'], ['Line Change', 'Name a Player from the same franchise who played the same position. +5 seconds.'], ['Hart Honor', 'Name a Hart Trophy winner. +5 seconds.'], ['All-Star', 'Name an All-Star. +5 seconds.'], ['Timeout', '+15 seconds.'], ['Forecheck', 'Your opponent only has 10 seconds on their next turn.']],
};
